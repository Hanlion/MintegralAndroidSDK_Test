...
public class NativeVideoRecycleViewActivity extends BaseActivity implements OnClickListener {

    private static final String TAG = NativeVideoRecycleViewActivity.class.getName();
    ...
    public void initView() {
        mBtNative = (Button) findViewById(R.id.mintegral_native_load);
    ...
    public void initData() {
        //change userInfo and report userInfo
        MainApplication.reportUser(33.33,-22.22);
        mTvTitle.setText("Native_Video_RecycleView");
    }
    ...
    public void preloadNative() {
        ...
        preloadMap.put(MIntegralConstans.NATIVE_VIDEO_SUPPORT, videoSupport);
...
//                Campaign campaign = mAllDatas.get(0);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.mintegral_native_load:
                preloadNative();
                break;
        ...
        private class VideoViewHolder extends RecyclerView.ViewHolder {
            ...
            public VideoViewHolder(View itemView) {
                ...
                if(mediaViewSet != null){
                    ...
                    //13.1.0 add
                    //ATTENTION PLEASE :
                    //If you call it, the full screen background color will change,
                    //please confirm the background color is you want.
                    mMediaview.setFullScreenViewBackgroundColor(0xFFCD5C5C);

                    //14.3.1 add
                    //ATTENTION PLEASE :
                    //If the parameters is TRUE, MintegralMediaView's orientation will follow the activity changes.
                    //If onConfigurationChanged() is callback, the MediaView will change orientation with system's Configuration.
                    //And functions adjusted according to the sensor will be disabled.
                    //Do not call this method in most cases.
                    mMediaview.setFollowActivityOrientation(false);
