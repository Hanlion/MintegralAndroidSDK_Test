...
public class AppwallActivity extends BaseActivity implements OnClickListener {
	private static final String TAG = AppwallActivity.class.getName();
	...
	public int getResLayoutId() {
		return R.layout.mintegral_demo_atv_appwall;
	}
